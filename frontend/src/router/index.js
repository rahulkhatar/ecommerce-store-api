...
const routes = [
  ...
  { path: '/inquiry', name: 'inquiry', component: () => import('@/pages/Inquiry.vue') },
  ...
  { path: '/admin/inquiries', name: 'admin-inquiries', component: () => import('@/pages/AdminInquiries.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
