...
description: ".NET 10 clean-architecture conventions for the ECommerce backend - the 5 layers (Domain, Application, Infrastructure, Persistence, API), entity/DTO/CQRS/repository/controller patterns, DI wiring, error handling, validation. Load before creating or reviewing any backend code (entities, services, controllers, EF configs)."
---
